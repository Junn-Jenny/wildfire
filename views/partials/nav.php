      ...
      <div class="flex h-16 justify-between">
        <div class="flex">
          <div class="flex flex-shrink-0 items-center">
            <img class="block h-8 w-auto lg:hidden" src="https://t3.ftcdn.net/jpg/02/35/26/30/360_F_235263034_miJw2igmixo7ymCqhHZ7c8wp9kaujzfM.jpg" alt="Your Company">
            <img class="hidden h-8 w-auto lg:block" src="https://t3.ftcdn.net/jpg/02/35/26/30/360_F_235263034_miJw2igmixo7ymCqhHZ7c8wp9kaujzfM.jpg" alt="Your Company">
          </div>
          <div class="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
            <!-- Current: "border-indigo-500 text-gray-900", Default: "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700" -->
            <a href="/"           class="<?= urlIs('/') ?       'border-indigo-500 text-gray-900':'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' ?> inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium" aria-current="page">Listing</a>
            <!--<a href="/detail" class="<?= urlIs('/detail') ? 'border-indigo-500 text-gray-900':'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' ?> inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium">Detail</a>-->
          ...
          <div class="relative ml-3">
            <div>
              <button type="button" class="relative flex max-w-xs items-center rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                ...
                <img class="h-8 w-8 rounded-full" src="https://scontent.flhr10-2.fna.fbcdn.net/v/t1.6435-9/60389902_10157194367585349_8871689978535477248_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=7a1959&_nc_ohc=bwNc9WVOx7kAX-YUmoM&_nc_ht=scontent.flhr10-2.fna&oh=00_AfAdvcWi7jcUWkSmOt_eKuPec6jkbYR-_BydXzK7nOMSlA&oe=6585502B" alt="">
              </button>
            </div>
    ...
    <div class="sm:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-200 pb-3 pt-4">
        <div class="flex items-center px-4">
          ...
          <div class="ml-3">
            <div class="text-base font-medium text-gray-800">Emerald Junn</div>
            <div class="text-sm font-medium text-gray-500">emeraldjunn@gmail.com</div>
          </div>
